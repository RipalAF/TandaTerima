        ...
        <table class="w-full border border-gray-300 rounded-lg overflow-hidden text-sm md:text-base">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-100 odd:bg-gray-50 even:bg-white transition">
                    <td class="py-2 px-4 border text-center"><?php echo $row['id']; ?></td>
                    ...
                    <td class="py-2 px-4 border text-center whitespace-nowrap">
                        ...
                        <a href="ditujukan.php?id=<?php echo $row['id']; ?>" class="px-3 py-1 bg-red-500 text-white rounded-md shadow-md hover:bg-red-600" onclick="return confirm('Apakah Anda yakin ingin menghapus?')">
                            Hapus
                        </a>
                    </td>
                </tr>
